...
$id = $_SESSION['userid'];
$sql = "SELECT Company, Street, City, State, Zip FROM user WHERE User_id=$id";
    ...
    <div class="wrapper">
        <div class="clientMain">
            <div class="mainContent">
                <h1><?php echo $row['Company'];?></h1> <!-- Will display user's name -->
                <img src="./states/<?php echo $row['State'];?>.png" alt="State picture" width="250" height="250" class="center"> <!-- Will display picture of user's registered state -->
                <a class="address"><?php echo $row['Street'] . " " . $row['City'] . ", " . $row['State'] . " " . $row['Zip'];?></a>
            </div>
