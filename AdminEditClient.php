...
<body class="clientBody">
    <div class="wrapper">
        ...
        <div class="clientButtons">
            <button type='submit' class="clientButton" form ='updateinfo'>Save Changes</button>
            <button class="clientButton" role="button" onclick="location.href = 'ViewUsers.php'">Back to Users</button>
        </div>
    </div>
</body>
